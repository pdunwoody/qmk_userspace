...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [6] = LAYOUT_split_3x6_3_ex2(KC_TRNS, RM_VALU, RM_SATU, RM_HUEU, RM_NEXT, RM_TOGG, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_NO, KC_TRNS, KC_TRNS, QK_LLCK, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI, KC_TRNS, KC_TRNS, RM_VALD, RM_SATD, RM_HUED, RM_PREV, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_MUTE, KC_MPLY, KC_MSTP, KC_NO, KC_NO, KC_NO),
